...
INSERT INTO user_data (id_user,user_name, email, pwd, first_name, first_last_name, second_last_name, birthdate, account_creation, is_premium) VALUES
('023ae982-cbe7-4136-a642-e96316a343a7','@usuario1', 'usuario1@example.com', md5('pass1'), 'Nombre1', 'Apellido1', 'Apellido2', '1990-01-01', NOW(), true);

INSERT INTO user_data (id_user,user_name, email, pwd, first_name, first_last_name, second_last_name, birthdate, account_creation, is_premium) VALUES
('74d7f463-f3b0-466b-ab2f-f03581e03a98','@daniel', 'despinosag02@educantabria.es', md5('1234'), 'Nombre1', 'Apellido1', 'Apellido2', '1990-01-01', NOW(), true),
('e7fce087-32f9-47c7-b014-70120c0d19cd','@ramiro', 'rgutierrezv03@educantabria.es', md5('1234'), 'Nombre1', 'Apellido1', 'Apellido2', '1990-01-01', NOW(), true),
('52ea00ad-e391-417b-a68c-78d7e0070877','@albano', 'adiezd07@educantabria.es', md5('1234'), 'Nombre1', 'Apellido1', 'Apellido2', '1990-01-01', NOW(), true);
